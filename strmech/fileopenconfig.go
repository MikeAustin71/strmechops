...
//		parameter will return the composite 'file open'
//		numeric code.
//
//	error
//
...
//
// If the current FileOpenConfig instance is valid and
// properly initialized, this method returns nil. If the
// current FileOpenConfig instance is invalid, this
...
//		FileOpenConfig are found to be invalid, this
...
func (fOpenCfg *FileOpenConfig) IsValidInstanceError(
