...
func TextTileLineTypeTestSetup0010(
	errorPrefix interface{}) (
	ucNames []string,
	lcNames []string,

	intValues []int,
	enumValues []TextTileLineType,
	err error) {
	...
	enumValues =
		append(enumValues, TextTileLineType(0).None())

	enumValues =
		append(enumValues, TextTileLineType(0).LeadingMarqueeLine())

	enumValues =
		append(enumValues, TextTileLineType(0).TitleLine())

	enumValues =
		append(enumValues, TextTileLineType(0).TrailingMarqueeLine())

	intValues =
		append(intValues, TitleLineType.None().XValueInt())

	intValues =
		append(intValues, TitleLineType.LeadingMarqueeLine().XValueInt())

	intValues =
		append(intValues, TitleLineType.TitleLine().XValueInt())

	intValues =
		append(intValues, TitleLineType.TrailingMarqueeLine().XValueInt())
...
func TestTextTileLineType_XValueInt_000100(t *testing.T) {

	ePrefix := ePref.ErrPrefixDto{}.NewEPrefCtx(
		"TestTextTileLineType_XValueInt_000100()",
		"")
	...
	var numberRoundingType1, numberRoundingType2,
		...
		numberRoundingType5, numberRoundingType6 TextTileLineType
...
func TestTextTileLineType_XReturnNoneIfInvalid_000200(t *testing.T) {

	ePrefix := ePref.ErrPrefixDto{}.NewEPrefCtx(
		"TestTextTileLineType_XReturnNoneIfInvalid_000200()",
		"")

	numberRoundingType := TextTileLineType(-972)
	...
	if valueNone.String() != "None" {
		...
		t.Errorf("%v\n"+
			"Error: Expected TextTileLineType(-972)\n"+
	...
	strTextTileLineType := numberRoundingType.String()

	strTextTileLineType = strings.ToLower(strTextTileLineType)

	if !strings.Contains(strTextTileLineType, "error") {

		t.Errorf("%v\n"+
			"Error: Expected TextTileLineType(-972).String()\n"+
	...
	var numberRoundingType2 TextTileLineType
...
func TestTextTileLineType_XValueInt_000300(t *testing.T) {

	ePrefix := ePref.ErrPrefixDto{}.NewEPrefCtx(
		"TestTextTileLineType_XValueInt_000300()",
		"")

	expectedIntValue := -972

	numberRoundingType := TextTileLineType(expectedIntValue)
