...
// termination sequence using one of the following methods:
//  TextLineSpecBlankLines.SetNewLineChars()
//
//
// ----------------------------------------------------------------
...
// NewRunesBlankLines - Returns a new, concrete instance of
// TextLineSpecBlankLines. The number of blank lines configured for
// this instance will be taken from input parameter,
// 'numOfBlankLines'.
//
...
//       the beginning of the error message.
//
func (blkLines TextLineSpecBlankLines) NewRunesBlankLines(
	numOfBlankLines int,
	newLineRunes []rune,
	errorPrefix interface{}) (
	TextLineSpecBlankLines,
...
// NewPtrRunesBlankLines - Returns a pointer to a new instance of
// TextLineSpecBlankLines. The number of blank lines configured for
// this instance will be taken from input parameter,
// 'numOfBlankLines'.
//
...
//       the beginning of the error message.
//
func (blkLines TextLineSpecBlankLines) NewPtrRunesBlankLines(
	numOfBlankLines int,
	newLineRunes []rune,
	errorPrefix interface{}) (
	*TextLineSpecBlankLines,
