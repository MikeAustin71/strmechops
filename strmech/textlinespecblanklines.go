...
// by the current instance of TextLineSpecBlankLines as well as the
// "new-line characters" used to generate those blank lines.
//
// The "new-line characters" will be automatically set to the
// new-line character '\n'.
//
// IMPORTANT
//
// This method will overwrite and delete all the existing data
// values for the current TextLineSpecBlankLines instance
// (blkLines).
//
...
// SetDefaultSpecBlankLines - Sets the number of blank lines
...
// Return Values
//
func (blkLines *TextLineSpecBlankLines) SetDefaultSpecBlankLines(
	numOfBlankLines int,
	errorPrefix interface{}) error {
	...
	ePrefix,
		err = ePref.ErrPrefixDto{}.NewIEmpty(
		errorPrefix,
		"TextLineSpecBlankLines.SetDefaultSpecBlankLines()",
		"")
