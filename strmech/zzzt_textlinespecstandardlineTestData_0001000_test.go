...
// createTestTextLineSpecStandardLine06 - Generates a
// TextLineSpecStandardLine object used for test operations.
//
// This test TextLineSpecStandardLine object uses a repeat
// count of 3.
//
// -----------------------------------------------------------------
//
...
//       attached at the beginning of the error message.
//
func createTestTextLineSpecStandardLine06(
	errorPrefix interface{}) (
	TextLineSpecStandardLine,
	error) {
