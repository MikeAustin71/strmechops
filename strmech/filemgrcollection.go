...
// the current instance of FileMgrCollection.
//
// A string is returned contained the comma delimited
// numeric value of the total bytes in the files contained
// in this collection (FileMgrCollection).
//
// ----------------------------------------------------------------
//
// # Input Parameters
...
//	string
//
//		This returned string contains the numeric value
//		of the total bytes in the files contained in the
//		current instance of FileMgrCollection. This
//		numeric value separate thousands with commas.
//
//	error
//
//		If this method completes successfully, the
...
//	 	The 'errorPrefix' text will be prefixed or
//	 	attached to the	beginning of the error message.
func (fMgrs *FileMgrCollection) GetTotalFileBytesCommaSeparated(
	errorPrefix interface{}) (
	string,
	error) {
