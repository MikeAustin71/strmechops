...
//		target directory after completion of the file
//		deletion operation.
//
...
//
// The current instance of DirMgr is used to define a top
// level parent directory. This method then proceeds to
// delete all files within that parent directory, all
// subdirectories in that parent directory and all files
// in the subdirectory trees within that parent
// directory.
//
// Upon completion, the top level parent directory
// identified by the current instance of DirMgr will
// remain. However, all previous contents within that
// parent directory, including files and subdirectories,
// will be deleted. The 'DirMgr' parent directory will
// therefore remain as a completely empty directory.
//
// ----------------------------------------------------------------
//
// # WARNING
...
//	residing in the parent directory identified by the
//	current instance of 'DirMgr'. Upon completion, only
//	the parent directory 'DirMgr' will remain as an empty
//	directory.
//
// ----------------------------------------------------------------
//
...
//		error message.
func (dMgr *DirMgr) DeleteAllInParentDirectory(
	errorPrefix interface{}) error {
...
//		parameter 'subDirsInDir'.
//
//		The parent directory defined by the current
//		instance of 'DirMgr' WILL NOT BE INCLUDED in the
//		returned Directory Manager Collection.
//
//	(2)	While scanning for subdirectories, selection and
//		addition of	Directory entries for the current
//		directory (".") and the parent directory ("..")
//		will be controlled by input parameters
