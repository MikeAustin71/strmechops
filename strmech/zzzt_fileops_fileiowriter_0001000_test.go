...
func TestFileIoWriter_Append_000400(t *testing.T) {
	...
	_,
		...
		NewPathFileName(
			...
			ePrefix.XCpy("targetIoWriterTwo<-"))
...
func TestFileIoWriter_ReadWrite_001100(t *testing.T) {

	funcName := "TestFileIoWriter_ReadWrite_001100()"
	...
	targetWriteFile = trashDirectory +
		...
		"TestFileIoWriter_ReadWrite_001100.txt"
...
func TestFileIoWriter_ReadFrom_002200(t *testing.T) {

	funcName := "TestFileIoWriter_ReadFrom_002200()"
	...
	targetWriteFile,
		err = new(fileOpsTestUtility).
		GetCompositeDir(
			"\\fileOpsTest\\trashDirectory\\TestFileIoWriter_ReadFrom_002200.txt",
			ePrefix.XCpy("targetWriteFile"))
...
func TestFileIoWriter_Seek_003300(t *testing.T) {

	funcName := "TestFileIoWriter_Seek_003300()"
	...
	targetWriteFile,
		err = new(fileOpsTestUtility).
		GetCompositeDir(
			"\\fileOpsTest\\trashDirectory\\TestFileIoWriter_Seek_003300.txt",
			ePrefix.XCpy("targetWriteFile"))
