...
// the file mode for the file identified by the input
// parameter 'pathFileName' using file permission codes
// provided by an instance of FilePermissionConfig passed
// as input parameter 'filePermission'.
//
...
//		text will be attached to the beginning of the
//		error message.
func (fh *FileHelper) ChmodFilePermConfig(
	pathFileName string,
	filePermissions FilePermissionConfig,
...
// the file mode for the file identified by the input
// parameter 'pathFileName' using file permission codes
// provided by a 10-character string of file permission
// text codes passed as input parameter
// 'filePermissionStr'.
//
// If the target file is a symbolic link, it changes the
// mode of the link's target. If there is an error, it
...
func (fh *FileHelper) ChmodPermissionStr(
	pathFileName string,
	filePermissionStr string,
	errorPrefix interface{}) error {
...
//	FileHelper.ReadTextLines(). The sole difference is
//	that this method uses default end-of-line delimiters:
//
//			"\n" and "\r\n"
//
// ----------------------------------------------------------------
...
//
//		This method is similar to method
//		FileHelper.ReadLines(). The sole difference is that
//	 this requires one or more customized end-of-line
...
// described by the 'fileInfo' parameter meets the
// specified File Selection Criteria and is judged to be
// a match for the fileSelectCriteria Regular Expression.
//
// 'fileSelectCriteria.RegularExp' is a pointer to a
// golang compiled regular expression. If the name
// passed by the os.FileInfo input parameter 'fileInfo'
// is a 'match' for the regular expression, the return
// parameter 'isRegexMatch' is set to 'true'.
//
// If the 'fileSelectCriteria.RegularExp' is passed as
// a 'nil' pointer, the return parameter 'isRegexSet'
// is set to 'false'.
//
// Note:
//
...
//		}
//
//		Be advised that type 'FileInfoPlus' implements
//		the 'os.FileInfo' interface, but offers additional
//		statistics and information on the subject file.
//		Type 'FileInfoPlus' can safely be passed as input
//		parameter 'fileInfo'.
//
//	fileSelectCriteria			FileSelectionCriteria
//
...
//		input paramter,
//		'fileSelectCriteria.SelectCriterionMode'.
func (fh *FileHelper) SearchFileRegexMatch(
	fileInfo os.FileInfo,
	fileSelectCriteria FileSelectionCriteria) (
	isRegexSet bool,
	isRegexMatch bool) {
	...
	isRegexSet,
		isRegexMatch = new(fileHelperElectron).
		searchFileRegexMatch(
			fileInfo,
			fileSelectCriteria)
