...
// therein to the underlying bufio.Writer encapsulated by
...
//		instance will be written to the bufio.Writer
...
//	 	The 'errorPrefix' text will be prefixed or
//	 	attached to the	beginning of the error message.
func (fBufWriter *FileBufferWriter) WriteRunes(
	runeArray *RuneArrayDto,
	autoFlushAndCloseOnExit bool,
	errorPrefix interface{}) (
	numOfBytesWritten int64,
	...
	if err2 != nil {
		...
		err1 = fmt.Errorf("%v\n"+
			"Error returned by fBufWriter.bufioWriter.Write(runeArray).\n"+
			"Error=\n%v\n",
			ePrefix.String(),
			err2.Error())
...
// WriteString
//
// Receives a string and proceeds to write this string to
// the previously configured internal bufio.writer
// destination configured for the current instance of
// FileBufferWriter.
//
// If input parameter 'autoFlushAndCloseOnExit' is set to
...
//	strToWrite					string
//
//		The contents of 'strToWrite' will be written to
//		the internal bufio.Writer destination
//		encapsulated by the current instance of
//		FileBufferWriter.
//
//		If 'strToWrite' is empty, or a zero length
...
//	 	The 'errorPrefix' text will be prefixed or
//	 	attached to the	beginning of the error message.
func (fBufWriter *FileBufferWriter) WriteString(
	strToWrite string,
	autoFlushAndCloseOnExit bool,
	errorPrefix interface{}) (
	numBytesWritten int64,
	...
	if len(strToWrite) == 0 {
		...
		err = fmt.Errorf("%v\n"+
			"Error: Input parameter 'strToWrite' is invalid!\n"+
			"'strToWrite' is an empty or zero length string.\n",
			ePrefix.String())
...
//
//		If this string array is empty, or consists of a
//		zero length string array, an error will be
//		returned.
//
//	autoFlushAndCloseOnExit		bool
//
...
//
//		Returns the number of bytes extracted from the
//		string array input parameter 'strArray' and
...
//	 	The 'errorPrefix' text will be prefixed or
//	 	attached to the	beginning of the error message.
func (fBufWriter *FileBufferWriter) WriteStringArray(
	strArray []string,
	autoFlushAndCloseOnExit bool,
	errorPrefix interface{}) (
	numOfStringsWritten int64,
	...
	if len(strArray) == 0 {
		...
		err = fmt.Errorf("%v\n"+
			...
			"'strArray' is an empty or zero length string array.\n",
			ePrefix.String())
...
//		string array input parameter 'strArray' and
//		written to the internal bufio.Writer object
//		encapsulated by the instance of FileBufferWriter
//		passed as input parameter 'fBufWriter'.
//
//	err							error
//
