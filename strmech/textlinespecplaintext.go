...
//     - A string which will be used to set the left margin of the
//       plain text line generated by the current instance of
//       TextLineSpecPlainText.
//
...
//
//       If the 'leftMargin' string exceeds one-million characters,
...
func (plainTextLine *TextLineSpecPlainText) SetLeftMarginChars(
	...
	if lenLeftMargin == 0 {
		plainTextLine.leftMarginChars = make([]rune, 0)
