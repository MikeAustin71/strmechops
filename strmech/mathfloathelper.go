...
//		the error message.
func (mathFloatHelper *MathFloatHelper) BigFloatFromPureNumStr(
	pureNumberStr string,
	decSeparatorChars string,
	leadingMinusSign bool,
	numOfExtraDigitsBuffer int64,
...
// # IMPORTANT
//
//	This method is similar to MathFloatHelper.
//	RaiseToFloatPositiveExponent(). However, this method
//	differs in that the user is responsible for computing
//	the value of precision bits.
//
//	The term 'precision bits' refers to the number of
//	bits in the mantissa of a big.Float floating point
//	number. Effectively, 'precision bits' controls the
...
//	capacity for a big.Float floating point number.
//
//	Method MathFloatHelper.RaiseToFloatPositiveExponent()
//	provides the option to compute the precision bits value,
//	automatically.
//
// ----------------------------------------------------------------
//
...
//	precisionBits 				uint
//
//		This value will be used to configure the precision
//		bits value used to configure the big.Float floating
//		point value returned when the 'base' value is raised
...
//		will be prefixed or attached at the beginning of
//		the error message.
func (mathFloatHelper *MathFloatHelper) RaiseToFloatPositivePower(
	base *big.Float,
	exponent int64,
	precisionBits uint,
	roundingMode big.RoundingMode,
