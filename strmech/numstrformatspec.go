...
func (numStrFmtSpec *NumStrFormatSpec) NewCurrencyNumFmtUS(
	...
	err = new(numStrFmtSpecNanobot).setCurrencyNStrFmtComponentsUS(
		&newSignedNumFmtSpec,
		numberFieldSpec,
...
//		array and 'intSeparatorSpec' is NOT equal to
//		'IntGroupingType.None()', an error will be returned.
//
//	intGroupingType				IntegerGroupingType
//
...
func (numStrFmtSpec *NumStrFormatSpec) SetCurrencyFmtUS(
	...
	return new(numStrFmtSpecNanobot).
		setCurrencyNStrFmtComponentsUS(
			numStrFmtSpec,
			numberFieldSpec,
...
//		the error message.
func (nStrNumberFieldSpecNanobot *numStrFmtSpecNanobot) setCurrencyNStrFmtComponentsUS(
	numStrFmtSpec *NumStrFormatSpec,
	numberFieldSpec NumStrNumberFieldSpec,
	errPrefDto *ePref.ErrPrefixDto) (
	err error) {
