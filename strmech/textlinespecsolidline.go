...
//       format a solid line of characters for text display, file
//       output, or printing.
//
//
//  err                        error
...
//       to format a solid line of characters for text display,
...
// SetSolidLineRepeatCount - Sets the number of times that solid
// line characters will be repeated in order to produce the final
// solid line text generated by this instance of
// TextLineSpecSolidLine.
//
// If the input parameter 'repeatCount' is set to a value less than
// zero or greater than one-million (1,000,000), the solid line
// repeat count will default to a value of one (1).
//
func (txtSpecSolidLine *TextLineSpecSolidLine) SetSolidLineRepeatCount(
	repeatCount int) {
	...
	if repeatCount < 0 ||
		...
		txtSpecSolidLine.solidLineCharsRepeatCount = 1

		return
	}

	txtSpecSolidLine.solidLineCharsRepeatCount = repeatCount
}
...
//      TextLineSpecSolidLine and writes that text to 'sBuilder'.
//
//
//  errorPrefix                interface{}
//     - This object encapsulates error prefix text which is
